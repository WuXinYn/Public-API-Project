...
/** smsUserLogin POST /api/user/sms/login */
export async function smsUserLoginUsingPost(
  body: API.SmsUserLoginRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseUserVO>('/api/user/sms/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** smsUserRegister POST /api/user/sms/register */
export async function smsUserRegisterUsingPost(
  body: API.SmsUserLoginRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponselong>('/api/user/sms/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
